...
export default function Home() {
	...
	return (
		<div className={"bg-[url('/bg.jpg')] object-contain"}>
			<Head>
				<title>transcript - Convert Audio To Text</title>
			</Head>

			<main className={`w-full h-screen`}>
				<div className={"max-w-5xl mx-auto text-primary"}>
					{/*header*/}
					<h1 className={"px-5 lg:px-0 py-4 text-5xl font-bold text-primary"}> Transcriber</h1>
						...
						<div className={"border grow overflow-auto bg-[#f7f5f5] text-black p-3 rounded"}>
							{
								transcript
									? transcript
									: <div className={"flex justify-center items-center h-full bg-opacity-0"}>Nothing here</div>
